      ...
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        ...
        <div class="x-panel-content" xid="content2"> 
          <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
            xid="contents1" onActiveChange="contents1ActiveChange" routable="true" slidable="true" swipe="false"> 
...
<span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog3" type="OKCancel" onOK="messageDialog3OK" message="本次考试还未开始计时，您选择退出考试，这不会浪费考试机会。" style="left:72px;top:32px;"></span></div>
